...
{
	#region PluginInfo
	[PluginInfo(Name = "SendTexture", Category = "Network", Help = "Basic raw template which copies up to count bytes from the input to the output", Tags = "")]
	#endregion PluginInfo
	public class NetworkSendTextureNode : IPluginEvaluate, IPartImportsSatisfiedNotification
	{
		#region fields & pins
		[Input("Input")]
